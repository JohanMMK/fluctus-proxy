      ...
      if (hit) {
        ...
        if (autoreport) {
          ...
          const kHtml = `<div style="font:15px/1.55 Helvetica,Arial,sans-serif;color:#1F3864;max-width:560px">
            ...
            <p>Met vriendelijke groeten,<br>EnergieKompas</p></div>`;
          const kSent = await _brevoMail(m.from, 'Uw energie-analyse staat klaar', kTxt, kHtml, 'Fluctus EnergieKompas');   // v15.156.1: ONGATED — inbound-rapport mag rechtstreeks naar de afzender/klant
